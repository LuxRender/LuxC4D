...
enum
{
  ...
  // LuxC4DResumeRender IDs
  IDS_LUXC4D_RESUMERENDER = 2000,
  IDS_LUXC4D_RESUMERENDER_DESCR,

  // LuxC4DSettings IDs
  IDS_LUXC4D_SETTINGS = 10000,

  // LuxC4DLightTag IDs
  IDS_LUXC4D_LIGHT_TAG = 11000,

  // LuxC4DCameraTag IDs
  IDS_LUXC4D_CAMERA_TAG = 12000,

  // LuxC4DCameraTag IDs
  IDS_LUXC4D_PORTAL_TAG = 13000,

  // LuxC4DMaterial IDs
  IDS_LUXC4D_MATERIAL = 14000,
