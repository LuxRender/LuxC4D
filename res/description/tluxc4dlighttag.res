...
CONTAINER Tluxc4dlighttag
{
  ...
  GROUP ID_TAGPROPERTIES {
    ...
    GROUP IDG_INFINITE_LIGHT {
      DEFAULT 1;

      REAL IDD_INFINITE_LIGHT_BRIGHTNESS { UNIT PERCENT;  MIN 0.0;  MINSLIDER 0.0;  MAXSLIDER 100.0;  STEP 1.0;  CUSTOMGUI REALSLIDER; }
      LONG IDD_INFINITE_LIGHT_SAMPLES    { MIN 1; }
      LONG IDD_INFINITE_LIGHT_TYPE {
        CYCLE {
          IDD_INFINITE_LIGHT_TYPE_AUTO;
