...
enum
{
  ...
  IDD_ROUGHNESS_ASYMETRIC,
    ...
    IDG_ROUGHNESS_SYM = 13000,
    IDD_ROUGHNESS_VALUE,
    IDD_ROUGHNESS_SHADER,

    IDG_ROUGHNESS_U = 13100,
    IDD_ROUGHNESS_U_VALUE,
    IDD_ROUGHNESS_U_SHADER,

    IDG_ROUGHNESS_V = 13200,
