...
enum
{
  ...
  IDG_OUTPUT = 20000,
    ...
    IDD_FLEXIMAGE_GAMMA,
    __IDD_FLEXIMAGE_TONEMAP_SETTINGS,         // deprecated
    ...
    __IDD_FLEXIMAGE_REINHARD_DUMMY,           // deprecated
    IDD_FLEXIMAGE_PREMULTIPLY,
    IDD_FLEXIMAGE_DISPLAY_INTERVAL,
    IDD_FLEXIMAGE_WRITE_INTERVAL,
    __IDD_FLEXIMAGE_WRITE_TONEMAPPED_TGA,     // deprecated
    __IDD_FLEXIMAGE_WRITE_TONEMAPPED_EXR,     // deprecated
    __IDD_FLEXIMAGE_WRITE_UNTONEMAPPED_EXR,   // deprecated
    __IDD_FLEXIMAGE_WRITE_TONEMAPPED_IGI,     // deprecated
    __IDD_FLEXIMAGE_WRITE_UNTONEMAPPED_IGI,   // deprecated
    ...
    IDD_FLEXIMAGE_REJECT_WARMUP,
      ...
      // fleximage colorspace group
      IDG_FLEXIMAGE_COLORSPACE = 23000,
      // the colorspace settings
      IDD_FLEXIMAGE_COLORSPACE_PRESET = 23100,
      IDD_FLEXIMAGE_COLORSPACE_RED_X,
      IDD_FLEXIMAGE_COLORSPACE_RED_Y,
      IDD_FLEXIMAGE_COLORSPACE_GREEN_X,
      IDD_FLEXIMAGE_COLORSPACE_GREEN_Y,
      IDD_FLEXIMAGE_COLORSPACE_BLUE_X,
      IDD_FLEXIMAGE_COLORSPACE_BLUE_Y,

        // the different colorspace presets
        IDD_FLEXIMAGE_COLORSPACE_CUSTOM = -1,
        ...
        IDD_FLEXIMAGE_COLORSPACE_NUMBER,

      // the whitepoint settings
      IDD_FLEXIMAGE_WHITEPOINT_PRESET = 23200,
      IDD_FLEXIMAGE_WHITEPOINT_X,
      IDD_FLEXIMAGE_WHITEPOINT_Y,

        // the different whitepoint presets
        IDD_FLEXIMAGE_WHITEPOINT_CUSTOM = -1,
        ...
        IDD_FLEXIMAGE_WHITEPOINT_NUMBER,
