...
CONTAINER VPluxc4dsettings
{
  ...
  GROUP IDG_RENDER {
    ...
    GROUP IDG_ACCELERATION {
      ...
      GROUP IDG_ACCELERATION_TABRECKDTREE {
        COLUMNS 2;
        LONG IDD_TABRECKDTREE_INTERSECTION_COST   { ANIM OFF;  MIN 1;  MAX 1000; }
        LONG IDD_TABRECKDTREE_TRAVERSAL_COST      { ANIM OFF;  MIN 1;  MAX 1000; }
        REAL IDD_TABRECKDTREE_EMPTY_BONUS         { ANIM OFF;  MIN 0.0;  MAX 100.0;  STEP 0.1; }
        STATICTEXT {}
        LONG IDD_TABRECKDTREE_MAX_PRIMITIVES      { ANIM OFF;  MIN 1;  MAX 1000; }
        LONG IDD_TABRECKDTREE_MAX_DEPTH           { ANIM OFF;  MIN -1;  MAX 100; }
      }
