...
CONTAINER VPluxc4dsettings
{
  ...
  GROUP IDG_RENDER {
    ...
    GROUP IDG_SAMPLING {
      ...
      GROUP IDG_METROPOLIS {
        ...
        LONG IDD_METROPOLIS_MUTATION_RANGE_TYPE {
          ANIM OFF;
          CYCLE {
            IDD_METROPOLIS_MUTATION_RANGE_AS_FRACTION;
            IDD_METROPOLIS_MUTATION_RANGE_IN_PIXEL;
          }
        }
        REAL IDD_METROPOLIS_MUTATION_RANGE_FRACTION         { ANIM OFF;  MIN 1.0;  MAX 1000.0;  STEP 1.0; }
        REAL IDD_METROPOLIS_MUTATION_RANGE_PIXEL            { ANIM OFF;  MIN 0.0;  MAX 1000.0;  STEP 1.0; }
      }
      ...
      GROUP IDG_ERPT {
        ...
        LONG IDD_ERPT_MUTATION_RANGE_TYPE {
          ANIM OFF;
          CYCLE {
            IDD_ERPT_MUTATION_RANGE_AS_FRACTION;
            IDD_ERPT_MUTATION_RANGE_IN_PIXEL;
          }
        }
        REAL IDD_ERPT_MUTATION_RANGE_FRACTION         { ANIM OFF;  MIN 1.0;  MAX 1000.0;  STEP 1.0; }
        REAL IDD_ERPT_MUTATION_RANGE_PIXEL            { ANIM OFF;  MIN 0.0;  MAX 1000.0;  STEP 1.0; }
      }
    ...
    GROUP IDG_FILTERING {
      ...
      GROUP IDG_MITCHELL_FILTER {
        ...
        BOOL IDD_MITCHELL_SUPERSAMPLE   { ANIM OFF; }
      }
  ...
  GROUP IDG_OUTPUT {
    ...
    GROUP IDG_FILM {
      ...
      GROUP IDG_FLEXIMAGE {
        ...
        GROUP IDG_FLEXIMAGE_COLORSPACE {
          COLUMNS 2;

          LONG IDD_FLEXIMAGE_COLORSPACE_PRESET {
            ANIM OFF;
            CYCLE {
              IDD_FLEXIMAGE_COLORSPACE_CUSTOM;
          ...
          STATICTEXT { JOINEND; }
          REAL IDD_FLEXIMAGE_COLORSPACE_RED_X   { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }
          REAL IDD_FLEXIMAGE_COLORSPACE_RED_Y   { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }
          REAL IDD_FLEXIMAGE_COLORSPACE_GREEN_X { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }
          REAL IDD_FLEXIMAGE_COLORSPACE_GREEN_Y { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }
          REAL IDD_FLEXIMAGE_COLORSPACE_BLUE_X  { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }
          REAL IDD_FLEXIMAGE_COLORSPACE_BLUE_Y  { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }

          LONG IDD_FLEXIMAGE_WHITEPOINT_PRESET {
            ANIM OFF;
            CYCLE {
          ...
          STATICTEXT { JOINEND; }
          REAL IDD_FLEXIMAGE_WHITEPOINT_X { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }
          REAL IDD_FLEXIMAGE_WHITEPOINT_Y { ANIM OFF;  MIN 0.0;  MAX 1.0; STEP 0.001; }
  ...
  GROUP IDG_EXPORT {
    ...
    BOOL IDD_DO_COLOUR_GAMMA_CORRECTION   { ANIM OFF; }
